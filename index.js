...
gamesCard.innerHTML = `${numGames} games`;
...
function filterUnfundedOnly() {
    ...
    console.log("Unfunded games:", unfundedGames); // 👈 This logs the filtered data
...
function filterFundedOnly() {
    ...
    console.log("Funded games:", fundedGames); // 👈 This logs the filtered data
